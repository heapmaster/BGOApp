...
derek = Country(name='Aperture Science',icon='static/img/aperture_science_flag.jpg',category='Scientific Research Company',dateEstablished='Upper Michigan, USA', description="", quote="Look at me still talking, when there's science to do.", quoteAuthor='GLaDOS', representative='Derek Alfsen')
