...
derek = Country(name='Aperture Science',icon='static/img/aperture_science_flag.jpg',category='Scientific Research Company',dateEstablished='Upper Michigan, USA', description="", quoteAuthor='GLaDOS', representative='Derek Alfsen')
